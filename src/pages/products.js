  ...
  <Layout>
    ...
    <ProductWrapper>
      <SideBySide reverse="row-reverse"
        headerThree=""
        headerTwo=""
        paragraph="Frey Farms controls the entire process from planting and harvesting to processing, packing and shipping. Our Team works closely with customers on both transportation efficiencies and food safety protocols to maintain a strong reputation in the industry. Frey includes customers in supply chain transparency from developing new seed varieties to harvest schedules and logistics. Every step in the process is overseen by our team, guaranteeing our customers receive superior service and high-quality pr."
...
query {
  hero: file(relativePath: { eq: "hero-images/products-hero.jpg" }) {
    childImageSharp {
